...
def letter_M(publisher):
    ...
    move(velocity_publisher,5.0, 1.0, True)
    move(velocity_publisher,5.0, 2.0, False)
    setDesiredOrientation(velocity_publisher,50,62)
    move(velocity_publisher,5.0, 3.4, True)
    move(velocity_publisher,5.0, 6.8, False)
    move(velocity_publisher,5.0, 6.8, True)
    setDesiredOrientation(velocity_publisher,50,285)
    move(velocity_publisher,5.0, 6.8, True)
