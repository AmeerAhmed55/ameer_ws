...
(cl:defmethod cl:initialize-instance :after ((m <Iot_sensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Iot_sensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_custom-msg:<Iot_sensor> is deprecated: use msg_custom-msg:Iot_sensor instead.")))
